...
Process Discovery techniques focus on learning a process model starting from a given set of logged traces. The majority of the approaches consider only one set of examples to learn from, i.e. the log itself. Some recent works instead advocated the usefulness of taking into account two different sets of traces (aka positive and negative examples), with the goal of learning a process model that \btext{is able}%allows
 to discriminate which trace belongs to which set.
