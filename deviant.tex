...
If the user wants the simplest model, \nd look for the solutions with the smallest closure and select the models with less constraints among those with closure of equal cardinality.\tododl{un esempio chiarirebbe meglio, ma non credo abbiamo spazio sufficiente}
